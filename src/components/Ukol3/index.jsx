  ...
  return (
    <>
      ...
      <div className="products">
        <Product  onSelectPrice={setPrice} image="/clothing/item01.jpg" name="Bunda" price={500} />
        <Product  onSelectPrice={setPrice} image="/clothing/item02.jpg" name="Halenka" price={1200} />
        <Product  onSelectPrice={setPrice} image="/clothing/item03.jpg" name="Svetr" price={1500} />
        <Product  onSelectPrice={setPrice} image="/clothing/item04.jpg" name="Mikina" price={800}/>
      </div>
    </>
  );
};
